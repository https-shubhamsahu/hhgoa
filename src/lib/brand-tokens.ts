/**
 * Hacker House Goa 2026 Official Brand Tokens
 * Source of Truth: extracted from C:\Users\shubh\_Active_Projects\hhgoa\visual things
 */

export const BRAND_COLORS = {
  palmGreen: '#036735',     // Deep Goan Emerald Palm Green
  sunYellow: '#FEE101',     // Official Electric Sun Yellow
  hotPink: '#FF0080',       // Official Hot Magenta/Pink
  sandCream: '#FFFBE8',     // Warm Goan Sand Cream
  midnightDark: '#03140C',  // Midnight Dark Green Container
  solidBlack: '#000000',    // Pure Black Outlines
} as const;
